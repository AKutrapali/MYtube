        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getDataVideo()];
                case 1:
                    data = _a.sent();
                    setQuantityVideoElement();
                    createVideoItem(data);
                    videoContainer.addEventListener('click', function () { playVideo(data, event); });
...
closedPlayBlockButton.addEventListener('click', function () { closePlayBlock(); });
